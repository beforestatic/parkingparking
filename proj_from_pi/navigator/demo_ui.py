...
Connects via WebSocket for real-time updates, falls back to polling.
"""
...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .transport { font-size: 0.6rem; color: #555; margin-left: 6px; }
    .dot {
...
<body>
  <div class="card">
    ...
    <div class="footer">
      <span>
        ...
        <span class="transport" id="transport-label"></span>
      </span>
  ...
  <script>
    ...
    function render(data) {
      ...
      container.innerHTML = "";
      if (data.tiers) data.tiers.forEach(t => container.appendChild(renderTier(t)));
    ...
    function setTransport(mode) {
      $("transport-label").textContent = mode === "ws" ? "· WS" : "· poll";
    }
    ...
    function connectWs() {
      ...
      ws.onopen = () => {
        setTransport("ws");
        // Stop polling while WS is alive
